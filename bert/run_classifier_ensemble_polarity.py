...
from modeling import BertConfig, BertForSequenceClassificationLSTM, BertForMultiLabelClassification
...
def main():
    ...
    parser.add_argument('--end', type=int, default=5, help="end fold")
...
def do_eval(model, device, eval_features, args):
    ...
    if args.local_rank == -1:
        ...
        test_sampler = DistributedSampler(eval_data)
    eval_dataloader = DataLoader(eval_data, sampler=test_sampler, batch_size=args.eval_batch_size)
    ...
    return logit_list, labels_eval_list
